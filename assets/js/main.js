...
function raschitat() {
    ...
    if (shirina == "") {
        alert("Бўйини киритмадингиз!");
    } else if (dlina == "") {
        alert("Энини киритманг!");
    } else {
        ploschad = parseFloat(shirina) * parseFloat(dlina);
        document.getElementById("ploschad").innerHTML =
            "Гиламингиз майдони: " + ploschad + " кв.метр";
        stoimost = ploschad * cena;
        document.getElementById("stoimost").innerHTML =
            "Жойда ювиш нархи: " + stoimost + " сум";
    }
}
